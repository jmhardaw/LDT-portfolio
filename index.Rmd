...
#### Upcoming Events
<ul>
  <li>NCSU Maymester Drop/Revision Deadline [Fri 27th May 2022]{.date} </li>
  <li>Memorial Day (University closed; No classes) [Mon 30th May 2022]{.date} </li>
  <li>NCSU Maymester Last Day of Classes [Wed 8th June 2022]{.date} </li>
  <li>NCSU Maymester Grades due by 5:00 p.m. [Fri 10th June 2022]{.date}
</li>
